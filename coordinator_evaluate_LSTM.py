...
import function_Evaluate_LSTM

print(function_Evaluate_LSTM.runModel(False, 'use7', 'all', False, True))
print(function_Evaluate_LSTM.runModel(True, 'use4', 'all', False, True))
...
#                 for e in E:
                        # print(f"{i}: {a} {b} {c} {d} {e} ")
                        # print(function_Evaluate_LSTM.runModel(a,b,c,d,e))
                        # i=i+1
